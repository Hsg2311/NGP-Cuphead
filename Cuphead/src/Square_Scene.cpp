...
Square_Scene::Square_Scene()
{
	...
	map1 = ResourceHandler::GetInst().LoadTexture(L"Map", L"/texture/overworld/Large Island/Left/Main/world1_large_island_main_01.png");
...
{
	map1->Draw(hdc, 0, 0, 1240, 1884, 0, 0, 1240, 1884);
